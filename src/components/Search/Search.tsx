...
text-ebony-700 dark:border-transparent bg-transparent dark:text-white dark:placeholder-junglegreen-600"
          />
          <span className="absolute left-0 top-0 flex h-full w-12 items-center justify-center rounded-2xl">
            <MagnifyingGlassIcon className="h-4 w-4 stroke-flamingo-600 fill-flamingo-500 dark:stroke-junglegreen-600 dark:fill-junglegreen-500" />
          </span>
        </form>

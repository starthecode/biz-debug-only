...
import PopupContext from '@/components/Extras/Popups/PopupContext';
...
const About = () => {
  ...
  return (
    <>
      <section className="relative overflow-hidden video-area video-two bg-inherit py-24 z-10 mt-28">
          ...
          <div className="row">
            <div className="col-12">
              <div className="w-full relative ring-ebony-200 dark:ring-white/10 ring-1 p-2 rounded-3xl bg-gradient-to-t from-onyx-900">
                <div className="relative group h-full inner-content pt-16 pb-20 border border-ebony-400/30 shadow-lg bg-white dark:bg-gradient-to-t from-onyx-950 to-woodsmoke-950">
                  ...
                  <div className="relativ text-center mb-4">
                    <div className="w-full flex justify-center items-center">
                      <div className="flex w-[40rem]">
                        <Heading3
                          small={'What does Bizmetric do'}
                          main={
                  ...
                  <div className="flex flex-col justify-center w-full items-center gap-5 mt-10">
                        ...
                        openPopup(
                          <div>
                            <iframe
                              width="560"
                              height="315"
                              src="https://www.youtube.com/embed/0DysrE4uCsk"
                    ...
                    <span className="mb-8 max-w-md text-center text-lg font-medium text-ebony-700 dark:text-[#9ca3af] mt-4">

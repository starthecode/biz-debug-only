        ...
        <div className="w-full text-center flex flex-col justify-center items-center">
          ...
          <div className="w-full flex items-center justify-center">
            <Heading3
              align={'center'}
              small={'Solutions'}
              main={postData?.solution?.title}
              specialTitle={''}
              classes={'font-inter'}
              desc={postData?.solution?.excerpt}
            />{' '}
          </div>
        </div>

        {postData?.solution?.solutions_field?.showSolutionVideo == true && (
          <div className="mx-auto px-2 w-fit mt-20">
                  ...
                  <div className="group relative overflow-hidden rounded-3xl p-7 box-hover-2 dark:before:bg-flamingo-500/20">
                    <div className="relative z-20 flex flex-col justify-center items-center">
                      <iframe
                        ...
                        width="620"
                        height="350"
                        src={`https://www.youtube-nocookie.com/embed/${postData?.solution?.solutions_field?.solutionVideo}_&amp;controls=0`}
            ...
            <div className="relative overflow-hidden max-w-2xl mx-auto text-center bg-white dark:bg-woodsmoke-950 rounded-2xl p-5">
              ...
              <div className="max-w-md mb-8 mx-auto ">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Please enter the details and submit the form below to check
                  our Azure Marketplace Offer, Case Studies and more.
                </p>
              </div>
              <div>
                <form>

  ...
  return (
    <>
      <section className="w-full items-center grid justify-center mt-40">
        <div className="bg-gray-400/20 dark:bg-onyx-900 relative p-[40px] md:pt-[91px] md:pr-[98px] md:pb-[86px] md:pl-[92px] mt-10 rounded-[58px]">
          <div className="mx-auto relative max-w-[1320px]">
            ...
            <div className="flex flex-col gap-8 mb-[15px] md:mb-[25px] lg:flex-row lg:gap-[50px] xl:gap-[98px]">
              ...
              <form className="flex-1" onSubmit={(e) => onSubmitForm(e)}>
                ...
                <textarea
                  className="w-full pt-5 resize-none outline-0 px-[30px] max-h-[150px] mb-[35px] mb-10"
                  cols={100}
                  rows={10}
                  name="emailDesc"

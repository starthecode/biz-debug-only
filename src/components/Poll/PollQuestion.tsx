...
const PollQuestion = () => {
  ...
  return (
    <>
      <div className="poll bg-white dark:bg-onyx-950/95 shadow-lg p-6 mx-auto transform rotate-90">
        <div className="question text-sm font-semibold mb-4 block text-[#F4FFFA00] bg-clip-text dark:bg-gradient-to-b dark:from-white dark:to-[#a0a0a0] bg-gradient-to-b from-ebony-400 to-ebony-950">
          {poll.question}
        </div>

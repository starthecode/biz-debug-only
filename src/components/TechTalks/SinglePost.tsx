          ...
          <div className="w-full text-center flex flex-col justify-center items-center mb-20">
            <div className="w-full">
              ...
              <Heading3
                align={'left'}
                small={'Blog'}
                main={postData?.post?.title}
                specialTitle={''}
                classes={'font-inter'}
                desc={postData?.post?.excerpt}
              />{' '}
            </div>
          </div>
          <div className="lg:w-4/5">
            <div className="flex gap-4">
              {postData.post.categories.nodes.map((cat: any, index: any) => (
                <Link
                  key={index}
            ...
            <div className="flex flex-wrap items-center justify-between gap-6">
              <div className="flex items-center gap-3 mt-7">
                <Image
                  width={30}
                  height={30}
                  src={postData?.post?.author?.node?.avatar?.url}
                  alt="avatar"
                  className="h-auto w-auto rounded-full"
                />
                <div>
                  <h6 className="text-sm transition-all hover:text-primary">
                    <a href="#">{postData?.post?.author?.node?.name}</a>
                  </h6>
                  <p className="text-sm text-gray-500">
                    {formatDate(postData?.post?.date)}
                  </p>
                </div>
              </div>
          ...
          <div>
            <div className="flex gap-3 my-6">
              ...
              <div>
                ...
                <p className="text-sm/relaxed tracking-wider text-onyx-300 mt-2">
